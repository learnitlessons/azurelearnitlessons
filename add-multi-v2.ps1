...
New-AzResourceGroup -Name "rg-lit-ADLab-weu" -Location "westeurope"
...
Get-AzPublicIpAddress -ResourceGroupName "rg-lit-ADLab-weu" | ForEach-Object { Write-Output "VM: $($_.Name.Replace('-pip','')) IP: $($_.IpAddress) RDP: mstsc /v:$($_.IpAddress) /u:$user" }
