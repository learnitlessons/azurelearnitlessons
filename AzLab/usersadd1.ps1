# Script to Repopulate AD Lab Structure with Verification
...
$remoteScript = {
    ...
    function Create-and-Verify-OUs {
        ...
        Write-Host "OU Creation: $created out of $total OUs created/verified successfully."
        return ($created -eq $total)
    }
    ...
    function Create-and-Verify-SecurityGroups {
        ...
        Write-Host "Security Group Creation: $created out of $total groups created/verified successfully."
        return ($created -eq $total)
    }
    ...
    function Create-and-Verify-Users {
        ...
        Write-Host "User Creation: $created out of $total users created/verified successfully."
        return ($created -eq $total)
    }
    ...
    function Create-and-Verify-ServiceAccounts {
        ...
        Write-Host "Service Account Creation: $created out of $total service accounts created/verified successfully."
        return ($created -eq $total)
    }
...
Write-Host "Executing Active Directory repopulation script with verification on $vmName..."
